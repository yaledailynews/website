...
export default async function Post({ params: paramsPromise }: Args) {
  ...
  return (
    <article className="max-w-7xl mx-auto flex flex-col gap-5 pb-6 sm:pb-8 md:pb-10 lg:pb-14 overflow-hidden">
      <PayloadRedirects disableNotFound url={url} />
      <div className="py-4 sm:py-6 md:py-8 lg:py-9 flex flex-col">
        <div className="max-w-screen-sm px-5 md:px-0 md:mx-0 flex flex-col gap-5 justify-start">
          {post.title && (
