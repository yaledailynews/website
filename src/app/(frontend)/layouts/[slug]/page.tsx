        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col gap-5">
              ...
              {block.blockType === 'layoutsArticles' && (
                <ArticlesBlock block={block} layout={layout} posts={posts} />
              )}
              {block.blockType === 'layoutsPodcasts' && (
                <PodcastsBlock block={block} layout={layout} />
              )}
              {block.blockType === 'layoutsNewsletter' && (
                <NewsletterBlock block={block} layout={layout} />
              )}
            </div>
          </div>
        )
